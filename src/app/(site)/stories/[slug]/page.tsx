...
import { getStory, getStorySlugs } from '@/sanity/lib/content';
...
/** Stories added in the admin panel after a deploy are rendered on first visit. */
    ...
    <article className="space-y-16 pb-16">
      ...
      <section className="max-w-4xl mx-auto px-4 space-y-8">
        ...
        <div className="space-y-6 font-body text-lg text-ink/90 leading-relaxed bg-field border-2 border-ink p-6 md:p-10">
          <RichText value={story.body} fallback={story.fullStory} />
        </div>
      </section>
